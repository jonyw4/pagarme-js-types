import {
  InputTransactionBoleto,
  InputTransactionCreditCart,
  InputTransactionPix
} from './Transaction';
...
interface InputTransactionBase {
  ...
  customer?: InputCustomer | { id: string };
...
export type InputTransaction = InputTransactionBase &
  (InputTransactionCreditCart | InputTransactionBoleto | InputTransactionPix);
